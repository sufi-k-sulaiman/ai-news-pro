...
import { Globe, Sparkles, BarChart3, Gamepad2, Settings, Radio, Brain, FileText, GraduationCap, ListTodo, StickyNote, Lightbulb, ScrollText, Newspaper, CloudSun } from 'lucide-react';
...
export const menuItems = [
    ...
    { label: 'Seasons', icon: CloudSun, href: createPageUrl('Seasons') },
