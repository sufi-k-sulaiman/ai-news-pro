...
const STOCK_DATA_EXTENDED = [
    ...
    // Additional 100 stocks batch 7
    { ticker: 'PDBC', name: 'Invesco Optimum Yield', sector: 'Finance', industry: 'Commodity ETF', marketCap: '5' },
    { ticker: 'GSG', name: 'iShares S&P GSCI Commodity', sector: 'Finance', industry: 'Commodity ETF', marketCap: '2' },
    { ticker: 'BND', name: 'Vanguard Total Bond Market', sector: 'Finance', industry: 'Bond ETF', marketCap: '95' },
    { ticker: 'AGG', name: 'iShares Core US Aggregate Bond', sector: 'Finance', industry: 'Bond ETF', marketCap: '90' },
    { ticker: 'TLT', name: 'iShares 20+ Year Treasury', sector: 'Finance', industry: 'Treasury ETF', marketCap: '35' },
    { ticker: 'IEF', name: 'iShares 7-10 Year Treasury', sector: 'Finance', industry: 'Treasury ETF', marketCap: '25' },
    { ticker: 'SHY', name: 'iShares 1-3 Year Treasury', sector: 'Finance', industry: 'Treasury ETF', marketCap: '22' },
    { ticker: 'LQD', name: 'iShares iBoxx Investment Grade', sector: 'Finance', industry: 'Corporate Bond ETF', marketCap: '35' },
    { ticker: 'HYG', name: 'iShares iBoxx High Yield', sector: 'Finance', industry: 'High Yield ETF', marketCap: '18' },
    { ticker: 'JNK', name: 'SPDR Bloomberg High Yield', sector: 'Finance', industry: 'High Yield ETF', marketCap: '8' },
    { ticker: 'MUB', name: 'iShares National Muni Bond', sector: 'Finance', industry: 'Muni Bond ETF', marketCap: '32' },
    { ticker: 'VCSH', name: 'Vanguard Short-Term Corporate', sector: 'Finance', industry: 'Corporate Bond ETF', marketCap: '38' },
    { ticker: 'VCIT', name: 'Vanguard Intermediate Corporate', sector: 'Finance', industry: 'Corporate Bond ETF', marketCap: '45' },
    { ticker: 'BSV', name: 'Vanguard Short-Term Bond', sector: 'Finance', industry: 'Bond ETF', marketCap: '35' },
    { ticker: 'BIV', name: 'Vanguard Intermediate Bond', sector: 'Finance', industry: 'Bond ETF', marketCap: '18' },
    { ticker: 'BNDX', name: 'Vanguard Total International Bond', sector: 'Finance', industry: 'International Bond ETF', marketCap: '45' },
    { ticker: 'EMB', name: 'iShares JP Morgan EM Bond', sector: 'Finance', industry: 'EM Bond ETF', marketCap: '15' },
    { ticker: 'TIPS', name: 'iShares TIPS Bond ETF', sector: 'Finance', industry: 'Inflation ETF', marketCap: '28' },
    { ticker: 'VTIP', name: 'Vanguard Short-Term Inflation', sector: 'Finance', industry: 'Inflation ETF', marketCap: '18' },
    { ticker: 'STIP', name: 'iShares 0-5 Year TIPS', sector: 'Finance', industry: 'Inflation ETF', marketCap: '8' },
    { ticker: 'AMLP', name: 'Alerian MLP ETF', sector: 'Energy', industry: 'MLP ETF', marketCap: '8' },
    { ticker: 'MLPA', name: 'Global X MLP ETF', sector: 'Energy', industry: 'MLP ETF', marketCap: '2' },
    { ticker: 'VNQ', name: 'Vanguard Real Estate ETF', sector: 'Real Estate', industry: 'REIT ETF', marketCap: '65' },
    { ticker: 'IYR', name: 'iShares US Real Estate', sector: 'Real Estate', industry: 'REIT ETF', marketCap: '5' },
    { ticker: 'SCHH', name: 'Schwab US REIT ETF', sector: 'Real Estate', industry: 'REIT ETF', marketCap: '8' },
    { ticker: 'RWR', name: 'SPDR Dow Jones REIT', sector: 'Real Estate', industry: 'REIT ETF', marketCap: '2' },
    { ticker: 'VNQI', name: 'Vanguard Global ex-US Real Estate', sector: 'Real Estate', industry: 'International REIT ETF', marketCap: '5' },
    { ticker: 'REM', name: 'iShares Mortgage Real Estate', sector: 'Real Estate', industry: 'Mortgage REIT ETF', marketCap: '1' },
    { ticker: 'MORT', name: 'VanEck Mortgage REIT Income', sector: 'Real Estate', industry: 'Mortgage REIT ETF', marketCap: '0.5' },
    { ticker: 'KBWY', name: 'Invesco KBW Premium Yield', sector: 'Real Estate', industry: 'REIT ETF', marketCap: '0.5' },
    { ticker: 'SRET', name: 'Global X SuperDividend REIT', sector: 'Real Estate', industry: 'REIT ETF', marketCap: '0.5' },
    { ticker: 'FREL', name: 'Fidelity MSCI Real Estate', sector: 'Real Estate', industry: 'REIT ETF', marketCap: '2' },
    { ticker: 'ICF', name: 'iShares Cohen & Steers REIT', sector: 'Real Estate', industry: 'REIT ETF', marketCap: '3' },
    { ticker: 'USRT', name: 'iShares Core US REIT', sector: 'Real Estate', industry: 'REIT ETF', marketCap: '2' },
    { ticker: 'NURE', name: 'NuShares Short-Term REIT', sector: 'Real Estate', industry: 'REIT ETF', marketCap: '0.5' },
    { ticker: 'HOMZ', name: 'Hoya Capital Housing ETF', sector: 'Real Estate', industry: 'Housing ETF', marketCap: '0.1' },
    { ticker: 'INDS', name: 'Pacer Industrial Real Estate', sector: 'Real Estate', industry: 'Industrial REIT ETF', marketCap: '0.5' },
    { ticker: 'PPTY', name: 'US Diversified Real Estate', sector: 'Real Estate', industry: 'REIT ETF', marketCap: '0.2' },
    { ticker: 'REZ', name: 'iShares Residential Real Estate', sector: 'Real Estate', industry: 'Residential REIT ETF', marketCap: '1' },
    { ticker: 'REET', name: 'iShares Global REIT ETF', sector: 'Real Estate', industry: 'Global REIT ETF', marketCap: '3' },
    { ticker: 'RWO', name: 'SPDR Dow Jones Global Real Estate', sector: 'Real Estate', industry: 'Global REIT ETF', marketCap: '2' },
    { ticker: 'WPS', name: 'iShares International Dev Property', sector: 'Real Estate', industry: 'International REIT ETF', marketCap: '0.5' },
    { ticker: 'IFGL', name: 'iShares International Dev Real Estate', sector: 'Real Estate', industry: 'International REIT ETF', marketCap: '0.3' },
    { ticker: 'HAUZ', name: 'Xtrackers International Real Estate', sector: 'Real Estate', industry: 'International REIT ETF', marketCap: '0.2' },
    { ticker: 'SRVR', name: 'Pacer Data & Infrastructure', sector: 'Real Estate', industry: 'Data Center REIT ETF', marketCap: '1' },
    { ticker: 'CQQQ', name: 'Invesco China Technology', sector: 'Technology', industry: 'China Tech ETF', marketCap: '1' },
    { ticker: 'CHIQ', name: 'Global X MSCI China Consumer', sector: 'Consumer', industry: 'China Consumer ETF', marketCap: '0.5' },
    { ticker: 'ASHR', name: 'Xtrackers Harvest CSI 300', sector: 'Finance', industry: 'China A-Shares ETF', marketCap: '2' },
    { ticker: 'GXC', name: 'SPDR S&P China ETF', sector: 'Finance', industry: 'China ETF', marketCap: '1' },
    { ticker: 'YINN', name: 'Direxion Daily FTSE China Bull', sector: 'Finance', industry: 'Leveraged China ETF', marketCap: '1' },
    { ticker: 'YANG', name: 'Direxion Daily FTSE China Bear', sector: 'Finance', industry: 'Inverse China ETF', marketCap: '0.5' },
    { ticker: 'PGJ', name: 'Invesco Golden Dragon China', sector: 'Finance', industry: 'China ADR ETF', marketCap: '0.5' },
    { ticker: 'CNYA', name: 'iShares MSCI China A ETF', sector: 'Finance', industry: 'China A-Shares ETF', marketCap: '0.3' },
    { ticker: 'CNXT', name: 'VanEck ChiNext ETF', sector: 'Finance', industry: 'China Growth ETF', marketCap: '0.1' },
    { ticker: 'ECNS', name: 'iShares MSCI China Small-Cap', sector: 'Finance', industry: 'China Small Cap ETF', marketCap: '0.1' },
    { ticker: 'CHIX', name: 'Global X MSCI China Financials', sector: 'Finance', industry: 'China Financials ETF', marketCap: '0.1' },
    { ticker: 'CHIH', name: 'Global X MSCI China Health Care', sector: 'Healthcare', industry: 'China Healthcare ETF', marketCap: '0.1' },
    { ticker: 'CHIC', name: 'Global X MSCI China Communication', sector: 'Technology', industry: 'China Telecom ETF', marketCap: '0.1' },
    { ticker: 'CHII', name: 'Global X MSCI China Industrials', sector: 'Industrials', industry: 'China Industrials ETF', marketCap: '0.1' },
    { ticker: 'CHIM', name: 'Global X MSCI China Materials', sector: 'Materials', industry: 'China Materials ETF', marketCap: '0.1' },
    { ticker: 'CHIE', name: 'Global X MSCI China Energy', sector: 'Energy', industry: 'China Energy ETF', marketCap: '0.1' },
    { ticker: 'CHIU', name: 'Global X MSCI China Utilities', sector: 'Utilities', industry: 'China Utilities ETF', marketCap: '0.1' },
    { ticker: 'CHIS', name: 'Global X MSCI China Consumer Staples', sector: 'Consumer', industry: 'China Staples ETF', marketCap: '0.1' },
    { ticker: 'KEJI', name: 'Global X China Innovation ETF', sector: 'Technology', industry: 'China Innovation ETF', marketCap: '0.1' },
    { ticker: 'KARS', name: 'KraneShares Electric Vehicles', sector: 'Automotive', industry: 'EV ETF', marketCap: '0.5' },
    { ticker: 'KGRN', name: 'KraneShares MSCI China Clean Tech', sector: 'Technology', industry: 'China Clean Tech ETF', marketCap: '0.1' },
    { ticker: 'KURE', name: 'KraneShares MSCI All China Health', sector: 'Healthcare', industry: 'China Healthcare ETF', marketCap: '0.2' },
    { ticker: 'KEMQ', name: 'KraneShares Emerging Markets Consumer', sector: 'Consumer', industry: 'EM Consumer ETF', marketCap: '0.1' },
    { ticker: 'KFVG', name: 'KraneShares CICC China Leaders', sector: 'Finance', industry: 'China Leaders ETF', marketCap: '0.1' },
    { ticker: 'OBOR', name: 'KraneShares MSCI One Belt One Road', sector: 'Finance', industry: 'Silk Road ETF', marketCap: '0.1' },
    { ticker: 'KALL', name: 'KraneShares MSCI All China', sector: 'Finance', industry: 'All China ETF', marketCap: '0.2' },
    { ticker: 'KBUY', name: 'KraneShares CICC China Consumer', sector: 'Consumer', industry: 'China Consumer ETF', marketCap: '0.1' },
    { ticker: 'PXH', name: 'Invesco FTSE RAFI Emerging Markets', sector: 'Finance', industry: 'EM ETF', marketCap: '2' },
    { ticker: 'DEM', name: 'WisdomTree Emerging Markets High Dividend', sector: 'Finance', industry: 'EM Dividend ETF', marketCap: '3' },
    { ticker: 'DGRE', name: 'WisdomTree Emerging Markets Quality Dividend', sector: 'Finance', industry: 'EM Dividend ETF', marketCap: '0.5' },
    { ticker: 'EEMS', name: 'iShares MSCI Emerging Markets Small-Cap', sector: 'Finance', industry: 'EM Small Cap ETF', marketCap: '0.5' },
    { ticker: 'EEMV', name: 'iShares MSCI Emerging Markets Min Vol', sector: 'Finance', industry: 'EM Low Vol ETF', marketCap: '5' },
    { ticker: 'SCHE', name: 'Schwab Emerging Markets Equity', sector: 'Finance', industry: 'EM ETF', marketCap: '10' },
    { ticker: 'SPEM', name: 'SPDR Portfolio Emerging Markets', sector: 'Finance', industry: 'EM ETF', marketCap: '8' },
    { ticker: 'DFAE', name: 'Dimensional Emerging Core Equity', sector: 'Finance', industry: 'EM ETF', marketCap: '5' },
    { ticker: 'AVEM', name: 'Avantis Emerging Markets Equity', sector: 'Finance', industry: 'EM ETF', marketCap: '3' },
    { ticker: 'APTS', name: 'Preferred Apartment Communities', sector: 'Real Estate', industry: 'Residential REITs', marketCap: '1' },
    { ticker: 'NXRT', name: 'NexPoint Residential Trust', sector: 'Real Estate', industry: 'Residential REITs', marketCap: '1' },
    { ticker: 'IRT', name: 'Independence Realty Trust', sector: 'Real Estate', industry: 'Residential REITs', marketCap: '5' },
    { ticker: 'ELME', name: 'Elme Communities', sector: 'Real Estate', industry: 'Residential REITs', marketCap: '2' },
    { ticker: 'VRE', name: 'Veris Residential', sector: 'Real Estate', industry: 'Residential REITs', marketCap: '2' },
    { ticker: 'APTS', name: 'Armada Hoffler Properties', sector: 'Real Estate', industry: 'Diversified REITs', marketCap: '1' },
    { ticker: 'AHH', name: 'Armada Hoffler', sector: 'Real Estate', industry: 'Mixed-Use REITs', marketCap: '1' },
    { ticker: 'CTO', name: 'CTO Realty Growth', sector: 'Real Estate', industry: 'Retail REITs', marketCap: '0.5' },
    { ticker: 'ESRT', name: 'Empire State Realty Trust', sector: 'Real Estate', industry: 'Office REITs', marketCap: '2' },
    { ticker: 'FSP', name: 'Franklin Street Properties', sector: 'Real Estate', industry: 'Office REITs', marketCap: '0.3' },
    { ticker: 'OPI', name: 'Office Properties Income Trust', sector: 'Real Estate', industry: 'Office REITs', marketCap: '0.5' },
    { ticker: 'CLI', name: 'Mack-Cali Realty', sector: 'Real Estate', industry: 'Office REITs', marketCap: '1' },
    { ticker: 'BDN', name: 'Brandywine Realty Trust', sector: 'Real Estate', industry: 'Office REITs', marketCap: '1' },
    { ticker: 'EQC', name: 'Equity Commonwealth', sector: 'Real Estate', industry: 'Office REITs', marketCap: '2' },
    { ticker: 'PGRE', name: 'Paramount Group', sector: 'Real Estate', industry: 'Office REITs', marketCap: '1' },
    // Additional 100 stocks batch 8
    { ticker: 'LTHM', name: 'Livent Corporation', sector: 'Materials', industry: 'Lithium', marketCap: '4' },
    { ticker: 'GEVO', name: 'Gevo Inc.', sector: 'Energy', industry: 'Renewable Fuels', marketCap: '1' },
    { ticker: 'CLNE', name: 'Clean Energy Fuels', sector: 'Energy', industry: 'Natural Gas', marketCap: '1' },
    { ticker: 'STEM', name: 'Stem Inc.', sector: 'Technology', industry: 'Energy Storage', marketCap: '1' },
    { ticker: 'QS', name: 'QuantumScape', sector: 'Automotive', industry: 'Solid-State Batteries', marketCap: '5' },
    { ticker: 'BLNK', name: 'Blink Charging', sector: 'Energy', industry: 'EV Charging', marketCap: '1' },
    { ticker: 'EVGO', name: 'EVgo Inc.', sector: 'Energy', industry: 'EV Charging', marketCap: '1' },
    { ticker: 'NKLA', name: 'Nikola Corporation', sector: 'Automotive', industry: 'Electric Trucks', marketCap: '1' },
    { ticker: 'HYLN', name: 'Hyliion Holdings', sector: 'Automotive', industry: 'Electric Trucks', marketCap: '1' },
    { ticker: 'GOEV', name: 'Canoo Inc.', sector: 'Automotive', industry: 'Electric Vehicles', marketCap: '0.5' },
    { ticker: 'FSR', name: 'Fisker Inc.', sector: 'Automotive', industry: 'Electric Vehicles', marketCap: '1' },
    { ticker: 'PTRA', name: 'Proterra Inc.', sector: 'Automotive', industry: 'Electric Buses', marketCap: '0.5' },
    { ticker: 'ARVL', name: 'Arrival SA', sector: 'Automotive', industry: 'Electric Vehicles', marketCap: '0.2' },
    { ticker: 'LEV', name: 'The Lion Electric', sector: 'Automotive', industry: 'Electric Trucks', marketCap: '0.5' },
    { ticker: 'WKHS', name: 'Workhorse Group', sector: 'Automotive', industry: 'Electric Vehicles', marketCap: '0.3' },
    { ticker: 'RIDE', name: 'Lordstown Motors', sector: 'Automotive', industry: 'Electric Trucks', marketCap: '0.1' },
    { ticker: 'MVST', name: 'Microvast Holdings', sector: 'Technology', industry: 'Battery Tech', marketCap: '0.5' },
    { ticker: 'DCFC', name: 'Tritium DCFC', sector: 'Energy', industry: 'EV Charging', marketCap: '0.2' },
    { ticker: 'EOSE', name: 'Eos Energy', sector: 'Technology', industry: 'Energy Storage', marketCap: '0.3' },
    { ticker: 'FLNC', name: 'Fluence Energy', sector: 'Technology', industry: 'Energy Storage', marketCap: '3' },
    { ticker: 'ENVX', name: 'Enovix Corporation', sector: 'Technology', industry: 'Battery Tech', marketCap: '2' },
    { ticker: 'SLDP', name: 'Solid Power', sector: 'Technology', industry: 'Solid-State Batteries', marketCap: '1' },
    { ticker: 'FREYR', name: 'FREYR Battery', sector: 'Technology', industry: 'Battery Manufacturing', marketCap: '1' },
    { ticker: 'AMPX', name: 'Amprius Technologies', sector: 'Technology', industry: 'Battery Tech', marketCap: '0.5' },
    { ticker: 'IONQ', name: 'IonQ Inc.', sector: 'Technology', industry: 'Quantum Computing', marketCap: '3' },
    { ticker: 'RGTI', name: 'Rigetti Computing', sector: 'Technology', industry: 'Quantum Computing', marketCap: '0.5' },
    { ticker: 'QUBT', name: 'Quantum Computing Inc.', sector: 'Technology', industry: 'Quantum Computing', marketCap: '0.2' },
    { ticker: 'ARQQ', name: 'Arqit Quantum', sector: 'Technology', industry: 'Quantum Security', marketCap: '0.3' },
    { ticker: 'QBTS', name: 'D-Wave Quantum', sector: 'Technology', industry: 'Quantum Computing', marketCap: '0.5' },
    { ticker: 'FORM', name: 'FormFactor Inc.', sector: 'Technology', industry: 'Semiconductor Equipment', marketCap: '3' },
    { ticker: 'ACLS', name: 'Axcelis Technologies', sector: 'Technology', industry: 'Semiconductor Equipment', marketCap: '5' },
    { ticker: 'UCTT', name: 'Ultra Clean Holdings', sector: 'Technology', industry: 'Semiconductor Equipment', marketCap: '2' },
    { ticker: 'ICHR', name: 'Ichor Holdings', sector: 'Technology', industry: 'Semiconductor Equipment', marketCap: '1' },
    { ticker: 'PLAB', name: 'Photronics Inc.', sector: 'Technology', industry: 'Photomasks', marketCap: '2' },
    { ticker: 'OLED', name: 'Universal Display', sector: 'Technology', industry: 'OLED Technology', marketCap: '8' },
    { ticker: 'KOPN', name: 'Kopin Corporation', sector: 'Technology', industry: 'Display Tech', marketCap: '0.2' },
    { ticker: 'VUZI', name: 'Vuzix Corporation', sector: 'Technology', industry: 'AR Glasses', marketCap: '0.2' },
    { ticker: 'LAZR', name: 'Luminar Technologies', sector: 'Technology', industry: 'Lidar', marketCap: '2' },
    { ticker: 'INVZ', name: 'Innoviz Technologies', sector: 'Technology', industry: 'Lidar', marketCap: '0.5' },
    { ticker: 'AEVA', name: 'Aeva Technologies', sector: 'Technology', industry: 'Lidar', marketCap: '0.3' },
    { ticker: 'OUST', name: 'Ouster Inc.', sector: 'Technology', industry: 'Lidar', marketCap: '0.5' },
    { ticker: 'VLDR', name: 'Velodyne Lidar', sector: 'Technology', industry: 'Lidar', marketCap: '0.3' },
    { ticker: 'CPTN', name: 'Cepton Inc.', sector: 'Technology', industry: 'Lidar', marketCap: '0.2' },
    { ticker: 'MVIS', name: 'MicroVision Inc.', sector: 'Technology', industry: 'Lidar', marketCap: '0.5' },
    { ticker: 'LIDR', name: 'AEye Inc.', sector: 'Technology', industry: 'Lidar', marketCap: '0.1' },
    { ticker: 'PRCT', name: 'Procept BioRobotics', sector: 'Healthcare', industry: 'Surgical Robotics', marketCap: '3' },
    { ticker: 'IART', name: 'Integra LifeSciences', sector: 'Healthcare', industry: 'Medical Devices', marketCap: '3' },
    { ticker: 'NUVA', name: 'NuVasive Inc.', sector: 'Healthcare', industry: 'Spine Surgery', marketCap: '3' },
    { ticker: 'GMED', name: 'Globus Medical', sector: 'Healthcare', industry: 'Spine Surgery', marketCap: '8' },
    { ticker: 'IRTC', name: 'iRhythm Technologies', sector: 'Healthcare', industry: 'Cardiac Monitoring', marketCap: '3' },
    { ticker: 'LIVN', name: 'LivaNova PLC', sector: 'Healthcare', industry: 'Cardiac Surgery', marketCap: '3' },
    { ticker: 'ATEC', name: 'Alphatec Holdings', sector: 'Healthcare', industry: 'Spine Surgery', marketCap: '2' },
    { ticker: 'AXNX', name: 'Axonics Inc.', sector: 'Healthcare', industry: 'Neuromodulation', marketCap: '3' },
    { ticker: 'INSP', name: 'Inspire Medical', sector: 'Healthcare', industry: 'Sleep Apnea', marketCap: '5' },
    { ticker: 'PODD', name: 'Insulet Corporation', sector: 'Healthcare', industry: 'Insulin Pumps', marketCap: '15' },
    { ticker: 'TNDM', name: 'Tandem Diabetes', sector: 'Healthcare', industry: 'Insulin Pumps', marketCap: '2' },
    { ticker: 'OFIX', name: 'Orthofix Medical', sector: 'Healthcare', industry: 'Orthopedics', marketCap: '1' },
    { ticker: 'OM', name: 'Outset Medical', sector: 'Healthcare', industry: 'Dialysis', marketCap: '0.5' },
    { ticker: 'RXST', name: 'RxSight Inc.', sector: 'Healthcare', industry: 'Ophthalmology', marketCap: '2' },
    { ticker: 'GKOS', name: 'Glaukos Corporation', sector: 'Healthcare', industry: 'Ophthalmology', marketCap: '3' },
    { ticker: 'EYES', name: 'Second Sight Medical', sector: 'Healthcare', industry: 'Ophthalmology', marketCap: '0.1' },
    { ticker: 'NVRO', name: 'Nevro Corp.', sector: 'Healthcare', industry: 'Neuromodulation', marketCap: '1' },
    { ticker: 'AXGN', name: 'Axogen Inc.', sector: 'Healthcare', industry: 'Nerve Repair', marketCap: '0.5' },
    { ticker: 'CNMD', name: 'CONMED Corporation', sector: 'Healthcare', industry: 'Surgical Devices', marketCap: '4' },
    { ticker: 'MMSI', name: 'Merit Medical Systems', sector: 'Healthcare', industry: 'Medical Devices', marketCap: '4' },
    { ticker: 'ICUI', name: 'ICU Medical', sector: 'Healthcare', industry: 'Infusion Systems', marketCap: '4' },
    { ticker: 'NVCR', name: 'NovoCure Limited', sector: 'Healthcare', industry: 'Cancer Treatment', marketCap: '3' },
    { ticker: 'RGNX', name: 'REGENXBIO Inc.', sector: 'Healthcare', industry: 'Gene Therapy', marketCap: '1' },
    { ticker: 'BLUE', name: 'bluebird bio', sector: 'Healthcare', industry: 'Gene Therapy', marketCap: '0.5' },
    { ticker: 'LEGN', name: 'Legend Biotech', sector: 'Healthcare', industry: 'Cell Therapy', marketCap: '10' },
    { ticker: 'FATE', name: 'Fate Therapeutics', sector: 'Healthcare', industry: 'Cell Therapy', marketCap: '1' },
    { ticker: 'PGEN', name: 'Precigen Inc.', sector: 'Healthcare', industry: 'Gene Therapy', marketCap: '0.5' },
    { ticker: 'ADPT', name: 'Adaptive Biotechnologies', sector: 'Healthcare', industry: 'Diagnostics', marketCap: '2' },
    { ticker: 'NTRA', name: 'Natera Inc.', sector: 'Healthcare', industry: 'Genetic Testing', marketCap: '12' },
    { ticker: 'MYGN', name: 'Myriad Genetics', sector: 'Healthcare', industry: 'Genetic Testing', marketCap: '2' },
    { ticker: 'NVTA', name: 'Invitae Corporation', sector: 'Healthcare', industry: 'Genetic Testing', marketCap: '0.5' },
    { ticker: 'TWST', name: 'Twist Bioscience', sector: 'Healthcare', industry: 'Synthetic DNA', marketCap: '2' },
    { ticker: 'CDNA', name: 'CareDx Inc.', sector: 'Healthcare', industry: 'Transplant Diagnostics', marketCap: '1' },
    ...
    { ticker: 'ILMN', name: 'Illumina Inc.', sector: 'Healthcare', industry: 'Genomic Sequencing', marketCap: '22' },
    { ticker: 'PACB', name: 'Pacific Biosciences', sector: 'Healthcare', industry: 'Genomic Sequencing', marketCap: '1' },
    { ticker: 'ONT', name: 'Oxford Nanopore', sector: 'Healthcare', industry: 'Genomic Sequencing', marketCap: '3' },
    { ticker: 'QGEN', name: 'Qiagen N.V.', sector: 'Healthcare', industry: 'Sample Prep', marketCap: '10' },
    { ticker: 'A', name: 'Agilent Technologies', sector: 'Healthcare', industry: 'Analytical Instruments', marketCap: '42' },
    { ticker: 'BRKR', name: 'Bruker Corporation', sector: 'Healthcare', industry: 'Scientific Instruments', marketCap: '10' },
    { ticker: 'NSTG', name: 'NanoString Technologies', sector: 'Healthcare', industry: 'Genomics', marketCap: '0.3' },
    { ticker: 'VCYT', name: 'Veracyte Inc.', sector: 'Healthcare', industry: 'Diagnostics', marketCap: '2' },
    { ticker: 'CERS', name: 'Cerus Corporation', sector: 'Healthcare', industry: 'Blood Safety', marketCap: '1' },
    { ticker: 'HAE', name: 'Haemonetics Corp.', sector: 'Healthcare', industry: 'Blood Management', marketCap: '4' },
    { ticker: 'CSTL', name: 'Castle Biosciences', sector: 'Healthcare', industry: 'Dermatology Diagnostics', marketCap: '1' },
    { ticker: 'BFLY', name: 'Butterfly Network', sector: 'Healthcare', industry: 'Ultrasound', marketCap: '0.5' },
    { ticker: 'SHLS', name: 'Shoals Technologies', sector: 'Energy', industry: 'Solar Components', marketCap: '3' },
    { ticker: 'ARRY', name: 'Array Technologies', sector: 'Energy', industry: 'Solar Trackers', marketCap: '2' },
    { ticker: 'MAXN', name: 'Maxeon Solar', sector: 'Energy', industry: 'Solar Panels', marketCap: '0.3' },
    { ticker: 'SPWR', name: 'SunPower Corporation', sector: 'Energy', industry: 'Solar Energy', marketCap: '1' },
    { ticker: 'JKS', name: 'JinkoSolar Holding', sector: 'Energy', industry: 'Solar Panels', marketCap: '2' },
    { ticker: 'CSIQ', name: 'Canadian Solar', sector: 'Energy', industry: 'Solar Energy', marketCap: '2' }
];

const STOCK_DATA_EXTENDED_2 = [
    { ticker: 'AGNC', name: 'AGNC Investment Corp.', sector: 'Real Estate', industry: 'Mortgage REITs', marketCap: '10' },
    { ticker: 'NLY', name: 'Annaly Capital Management', sector: 'Real Estate', industry: 'Mortgage REITs', marketCap: '10' },
    { ticker: 'ARR', name: 'ARMOUR Residential REIT', sector: 'Real Estate', industry: 'Mortgage REITs', marketCap: '1' },
    { ticker: 'IVR', name: 'Invesco Mortgage Capital', sector: 'Real Estate', industry: 'Mortgage REITs', marketCap: '0.5' },
    { ticker: 'TWO', name: 'Two Harbors Investment', sector: 'Real Estate', industry: 'Mortgage REITs', marketCap: '2' },
    { ticker: 'PMT', name: 'PennyMac Mortgage', sector: 'Real Estate', industry: 'Mortgage REITs', marketCap: '2' },
    { ticker: 'CIM', name: 'Chimera Investment', sector: 'Real Estate', industry: 'Mortgage REITs', marketCap: '2' },
    { ticker: 'ORC', name: 'Orchid Island Capital', sector: 'Real Estate', industry: 'Mortgage REITs', marketCap: '0.5' },
    { ticker: 'DX', name: 'Dynex Capital', sector: 'Real Estate', industry: 'Mortgage REITs', marketCap: '1' },
    { ticker: 'WMC', name: 'Western Asset Mortgage', sector: 'Real Estate', industry: 'Mortgage REITs', marketCap: '0.2' },
    { ticker: 'LADR', name: 'Ladder Capital', sector: 'Real Estate', industry: 'Mortgage REITs', marketCap: '2' },
    { ticker: 'BXMT', name: 'Blackstone Mortgage Trust', sector: 'Real Estate', industry: 'Mortgage REITs', marketCap: '5' },
    { ticker: 'STWD', name: 'Starwood Property Trust', sector: 'Real Estate', industry: 'Mortgage REITs', marketCap: '7' },
    { ticker: 'ACRE', name: 'Ares Commercial Real Estate', sector: 'Real Estate', industry: 'Mortgage REITs', marketCap: '1' },
    { ticker: 'KREF', name: 'KKR Real Estate Finance', sector: 'Real Estate', industry: 'Mortgage REITs', marketCap: '1' },
    { ticker: 'TCI', name: 'Transcontinental Realty', sector: 'Real Estate', industry: 'Diversified REITs', marketCap: '0.3' },
    { ticker: 'AHT', name: 'Ashford Hospitality Trust', sector: 'Real Estate', industry: 'Hotel REITs', marketCap: '0.1' },
    { ticker: 'CIO', name: 'City Office REIT', sector: 'Real Estate', industry: 'Office REITs', marketCap: '0.3' },
    { ticker: 'DEA', name: 'Easterly Government', sector: 'Real Estate', industry: 'Office REITs', marketCap: '1' },
    { ticker: 'FPI', name: 'Farmland Partners', sector: 'Real Estate', industry: 'Farmland REITs', marketCap: '0.5' },
    { ticker: 'LAND', name: 'Gladstone Land', sector: 'Real Estate', industry: 'Farmland REITs', marketCap: '0.5' },
    { ticker: 'SAFE', name: 'Safehold Inc.', sector: 'Real Estate', industry: 'Ground Lease REITs', marketCap: '1' },
    { ticker: 'WY', name: 'Weyerhaeuser', sector: 'Real Estate', industry: 'Timber REITs', marketCap: '25' },
    { ticker: 'PCH', name: 'PotlatchDeltic', sector: 'Real Estate', industry: 'Timber REITs', marketCap: '4' },
    { ticker: 'RYN', name: 'Rayonier Inc.', sector: 'Real Estate', industry: 'Timber REITs', marketCap: '5' },
    { ticker: 'CTT', name: 'CatchMark Timber', sector: 'Real Estate', industry: 'Timber REITs', marketCap: '0.5' },
    { ticker: 'GEO', name: 'GEO Group', sector: 'Real Estate', industry: 'Prison REITs', marketCap: '2' },
    { ticker: 'CXW', name: 'CoreCivic, Inc.', sector: 'Real Estate', industry: 'Prison REITs', marketCap: '2' },
    { ticker: 'IRM', name: 'Iron Mountain', sector: 'Real Estate', industry: 'Specialty REITs', marketCap: '22' },
    { ticker: 'OUT', name: 'Outfront Media', sector: 'Real Estate', industry: 'Billboard REITs', marketCap: '3' },
    { ticker: 'LMRK', name: 'Lamar Advertising', sector: 'Real Estate', industry: 'Billboard REITs', marketCap: '12' },
    { ticker: 'CCO', name: 'Clear Channel Outdoor', sector: 'Real Estate', industry: 'Billboard REITs', marketCap: '1' },
    { ticker: 'RICK', name: 'RCI Hospitality Holdings', sector: 'Consumer', industry: 'Entertainment', marketCap: '1' },
    { ticker: 'PLAY', name: 'Dave & Busters', sector: 'Consumer', industry: 'Restaurants', marketCap: '2' },
    { ticker: 'DENN', name: 'Dennys Corp', sector: 'Consumer', industry: 'Restaurants', marketCap: '0.5' },
    { ticker: 'BLMN', name: 'Bloomin Brands', sector: 'Consumer', industry: 'Restaurants', marketCap: '3' },
    { ticker: 'EAT', name: 'Brinker International', sector: 'Consumer', industry: 'Restaurants', marketCap: '2' },
    { ticker: 'CAKE', name: 'Cheesecake Factory', sector: 'Consumer', industry: 'Restaurants', marketCap: '2' },
    { ticker: 'CBRL', name: 'Cracker Barrel', sector: 'Consumer', industry: 'Restaurants', marketCap: '1' },
    { ticker: 'TXRH', name: 'Texas Roadhouse', sector: 'Consumer', industry: 'Restaurants', marketCap: '10' },
    { ticker: 'RRGB', name: 'Red Robin Gourmet', sector: 'Consumer', industry: 'Restaurants', marketCap: '0.2' },
    { ticker: 'BJRI', name: 'BJs Restaurants', sector: 'Consumer', industry: 'Restaurants', marketCap: '1' },
    { ticker: 'DIN', name: 'Dine Brands Global', sector: 'Consumer', industry: 'Restaurants', marketCap: '1' },
    { ticker: 'JACK', name: 'Jack in the Box', sector: 'Consumer', industry: 'Restaurants', marketCap: '2' },
    { ticker: 'QSR', name: 'Restaurant Brands', sector: 'Consumer', industry: 'Restaurants', marketCap: '32' },
    { ticker: 'WEN', name: 'Wendys Company', sector: 'Consumer', industry: 'Restaurants', marketCap: '4' },
    { ticker: 'NDLS', name: 'Noodles & Company', sector: 'Consumer', industry: 'Restaurants', marketCap: '0.2' },
    { ticker: 'SHAK', name: 'Shake Shack', sector: 'Consumer', industry: 'Restaurants', marketCap: '4' },
    { ticker: 'WING', name: 'Wingstop Inc.', sector: 'Consumer', industry: 'Restaurants', marketCap: '12' },
    { ticker: 'PZZA', name: 'Papa Johns', sector: 'Consumer', industry: 'Restaurants', marketCap: '3' },
    { ticker: 'KR', name: 'Kroger Co.', sector: 'Consumer', industry: 'Grocery Stores', marketCap: '40' },
    { ticker: 'ACI', name: 'Albertsons Companies', sector: 'Consumer', industry: 'Grocery Stores', marketCap: '12' },
    { ticker: 'IMKTA', name: 'Ingles Markets', sector: 'Consumer', industry: 'Grocery Stores', marketCap: '2' },
    { ticker: 'WMK', name: 'Weis Markets', sector: 'Consumer', industry: 'Grocery Stores', marketCap: '2' },
    { ticker: 'GO', name: 'Grocery Outlet', sector: 'Consumer', industry: 'Grocery Stores', marketCap: '3' },
    { ticker: 'UNFI', name: 'United Natural Foods', sector: 'Consumer', industry: 'Food Distribution', marketCap: '1' },
    { ticker: 'PRTY', name: 'Party City', sector: 'Consumer', industry: 'Specialty Retail', marketCap: '0.1' },
    { ticker: 'JOAN', name: 'JOANN Inc.', sector: 'Consumer', industry: 'Crafts Retail', marketCap: '0.1' },
    { ticker: 'MW', name: 'Mens Wearhouse', sector: 'Consumer', industry: 'Apparel Retail', marketCap: '0.5' },
    { ticker: 'CHS', name: 'Chicos FAS', sector: 'Consumer', industry: 'Apparel Retail', marketCap: '1' },
    { ticker: 'GPS', name: 'Gap Inc.', sector: 'Consumer', industry: 'Apparel Retail', marketCap: '10' },
    { ticker: 'JWN', name: 'Nordstrom Inc.', sector: 'Consumer', industry: 'Department Stores', marketCap: '4' },
    { ticker: 'M', name: 'Macys Inc.', sector: 'Consumer', industry: 'Department Stores', marketCap: '6' },
    { ticker: 'KSS', name: 'Kohls Corp.', sector: 'Consumer', industry: 'Department Stores', marketCap: '6' },
    { ticker: 'DDS', name: 'Dillards Inc.', sector: 'Consumer', industry: 'Department Stores', marketCap: '7' },
    { ticker: 'JCP', name: 'J.C. Penney', sector: 'Consumer', industry: 'Department Stores', marketCap: '0.5' },
    { ticker: 'TLYS', name: 'Tillys Inc.', sector: 'Consumer', industry: 'Apparel Retail', marketCap: '0.3' },
    { ticker: 'ZUMZ', name: 'Zumiez Inc.', sector: 'Consumer', industry: 'Apparel Retail', marketCap: '0.5' },
    { ticker: 'ANF', name: 'Abercrombie & Fitch', sector: 'Consumer', industry: 'Apparel Retail', marketCap: '8' },
    { ticker: 'AEO', name: 'American Eagle', sector: 'Consumer', industry: 'Apparel Retail', marketCap: '4' },
    { ticker: 'URBN', name: 'Urban Outfitters', sector: 'Consumer', industry: 'Apparel Retail', marketCap: '4' },
    { ticker: 'BOOT', name: 'Boot Barn Holdings', sector: 'Consumer', industry: 'Apparel Retail', marketCap: '4' },
    { ticker: 'SCVL', name: 'Shoe Carnival', sector: 'Consumer', industry: 'Footwear Retail', marketCap: '1' },
    { ticker: 'FL', name: 'Foot Locker', sector: 'Consumer', industry: 'Footwear Retail', marketCap: '3' },
    { ticker: 'DSW', name: 'Designer Brands', sector: 'Consumer', industry: 'Footwear Retail', marketCap: '1' },
    { ticker: 'CAL', name: 'Caleres Inc.', sector: 'Consumer', industry: 'Footwear', marketCap: '1' },
    { ticker: 'WWW', name: 'Wolverine World Wide', sector: 'Consumer', industry: 'Footwear', marketCap: '1' },
    ...
    { ticker: 'VFC', name: 'VF Corporation', sector: 'Consumer', industry: 'Apparel', marketCap: '8' },
    { ticker: 'UAA', name: 'Under Armour', sector: 'Consumer', industry: 'Apparel', marketCap: '4' },
    { ticker: 'PUMA', name: 'Puma SE', sector: 'Consumer', industry: 'Apparel', marketCap: '8' },
    { ticker: 'ADDYY', name: 'Adidas AG', sector: 'Consumer', industry: 'Apparel', marketCap: '45' },
    { ticker: 'COLM', name: 'Columbia Sportswear', sector: 'Consumer', industry: 'Apparel', marketCap: '5' },
    { ticker: 'GPRO', name: 'GoPro Inc.', sector: 'Technology', industry: 'Consumer Electronics', marketCap: '0.5' },
    { ticker: 'SFIX', name: 'Stitch Fix', sector: 'Consumer', industry: 'E-Commerce', marketCap: '0.5' },
    { ticker: 'REAL', name: 'The RealReal', sector: 'Consumer', industry: 'E-Commerce', marketCap: '0.5' },
    { ticker: 'POSH', name: 'Poshmark', sector: 'Consumer', industry: 'E-Commerce', marketCap: '1' },
    { ticker: 'WISH', name: 'ContextLogic', sector: 'Consumer', industry: 'E-Commerce', marketCap: '1' },
    { ticker: 'CHWY', name: 'Chewy Inc.', sector: 'Consumer', industry: 'E-Commerce', marketCap: '10' },
    { ticker: 'CVNA', name: 'Carvana Co.', sector: 'Consumer', industry: 'Used Cars', marketCap: '15' },
    { ticker: 'KMX', name: 'CarMax Inc.', sector: 'Consumer', industry: 'Used Cars', marketCap: '12' },
    { ticker: 'VRM', name: 'Vroom Inc.', sector: 'Consumer', industry: 'Used Cars', marketCap: '0.1' },
    { ticker: 'SFT', name: 'Shift Technologies', sector: 'Consumer', industry: 'Used Cars', marketCap: '0.1' },
    { ticker: 'LOTZ', name: 'Lotz Inc.', sector: 'Consumer', industry: 'Used Cars', marketCap: '0.1' }
];

// Combine all stocks
const ALL_STOCK_DATA = [...STOCK_DATA, ...STOCK_DATA_EXTENDED, ...STOCK_DATA_EXTENDED_2];
