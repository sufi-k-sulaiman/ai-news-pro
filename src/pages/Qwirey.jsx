    ...
    const handleStyleChange = async (style) => {
        ...
        try {
            const styleInstructions = {
                ...
                essay: 'CRITICAL: Transform this into an unbiased, comprehensive essay with EXACTLY 1400-1500 words. IMPORTANT: Count carefully - each paragraph MUST be 120-150 words. Structure as follows: 1) Engaging title (no brand names, no links). 2) EXACTLY 10-12 substantial paragraphs (120-150 words EACH) covering the topic thoroughly from multiple perspectives with deep analysis, examples, explanations, and detailed exploration. 3) Use formal academic tone. 4) Present balanced viewpoints without bias. 5) Avoid ANY brand names, product names, or promotional content. 6) NO hyperlinks or URLs whatsoever. 7) Focus on concepts, theories, principles, and general knowledge rather than specific products or companies. 8) Each paragraph should explore a distinct aspect in depth with thorough explanations. 9) Total word count MUST be between 1400-1500 words. Make it educational, objective, and comprehensive.'
            };
