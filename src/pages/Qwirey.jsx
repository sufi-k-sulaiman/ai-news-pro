    ...
    const handleStyleChange = async (style) => {
        ...
        try {
            const styleInstructions = {
                ...
                essay: 'CRITICAL WORD COUNT REQUIREMENT: You MUST generate EXACTLY 1400-1500 TOTAL WORDS. This is NON-NEGOTIABLE.\n\nEXPAND the original content significantly into a comprehensive academic essay with these STRICT requirements:\n\n1) Create an engaging, professional title (NO brand names, NO links)\n\n2) Write EXACTLY 12 PARAGRAPHS. Each paragraph MUST contain 120-130 words (count them!). This gives you approximately 1440-1560 words total.\n\n3) EXPAND each idea from the original into much longer, more detailed explanations. Add:\n   - Multiple examples per concept\n   - Theoretical frameworks\n   - Historical context where relevant\n   - Comparative analysis\n   - Implications and consequences\n   - Different perspectives and viewpoints\n\n4) Use formal academic tone throughout\n\n5) Maintain complete objectivity - NO bias, NO brand names, NO product names, NO promotional language\n\n6) ABSOLUTELY NO hyperlinks or URLs of any kind\n\n7) Focus on general concepts, theories, and principles rather than specific products/companies\n\n8) Each paragraph explores ONE distinct aspect in great depth with extensive explanation\n\nREMEMBER: Your output MUST be 1400-1500 words. Count carefully. If unsure, write MORE rather than less. Make each paragraph rich with detail, examples, and analysis.'
            };
