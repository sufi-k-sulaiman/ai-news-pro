...
import { 
    ...
    Menu, ChevronLeft, Moon, Sun, Type, EyeOff, Eye, BarChart3, TestTube, Radio
} from 'lucide-react';
...
export default function Settings() {
    ...
    return (
        <div className={`min-h-screen flex flex-col ${darkMode ? 'bg-[#0D1321]' : 'bg-gray-50'}`}>
            {/* Header */}
                ...
                <main className="flex-1 p-8 overflow-auto">
                    <div className="max-w-2xl mx-auto">
                        ...
                        <div className="space-y-6">
                            {/* Theme Toggle */}
                            <div className={`p-6 rounded-2xl border ${darkMode ? 'bg-[#1A1F2E] border-gray-800' : 'bg-white border-gray-200'}`}>
